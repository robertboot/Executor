...
interface Props {
  inventoryId: string;
  itemId: string;
  /** When true, hides the breadcrumb (used inside master-detail panels). */
  embedded?: boolean;
}

export default function ItemDetailView({ inventoryId, itemId, embedded }: Props) {
  ...
  return (
    <View style={{ flex: 1, backgroundColor: colors.cream }}>
      <ScrollView contentContainerStyle={styles.scroll}>
        {/* Crumb + actions — hidden when embedded in a master-detail panel */}
        {!embedded && (
